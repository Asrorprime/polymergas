...
// @ts-ignore
class CurrentOrderLinksTwoComponent extends React.Component {
  state: initialState;
  props: any
                    ...
                    <div className="h-100">
                      <div className="d-flex align-items-center h-100">
                        <div className="">
                          ...
                          {/*        onClick={() => {*/}
                          {/*          pushNextModal();*/}
                          {/*          setMyState("myFunction", () => changeToPayed(item.userOrderId, false, 2))*/}
                          {/*        }}>*/}
                          ...
                          {/*        onClick={() => {*/}
                          {/*          pushNextModal();*/}
                          {/*          setMyState("myFunction", () => changeToPayed(item.userOrderId, true, 2))*/}
                          {/*        }}>*/}
...
export default CurrentOrderLinksTwoComponent;
