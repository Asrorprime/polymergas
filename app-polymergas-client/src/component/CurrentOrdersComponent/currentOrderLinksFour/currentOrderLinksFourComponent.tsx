...
// @ts-ignore
class CurrentOrderLinksFourComponent extends React.Component {
  state: initialState;
  props: any
                    ...
                    <div className="h-100">
                      <div className="d-flex align-items-center h-100">
                        <div className="">
                          ...
                          <div className="d-flex justify-content-center w-100 align-items-center my-2">
                            <div className="change-order-btn btn-size-md">
                              <button
                                id="toCreated"
                                onClick={
...
export default CurrentOrderLinksFourComponent;
