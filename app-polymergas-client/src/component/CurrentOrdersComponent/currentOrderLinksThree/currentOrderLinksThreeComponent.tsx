...
// @ts-ignore
class CurrentOrderLinksThreeComponent extends React.Component {
  state: initialState;
  props: any
                    ...
                    <div className="h-100">
                      <div className="d-flex align-items-center h-100">
                        <div className="">
                          ...
                          <div className="d-flex align-items-center my-2">
                            <div className="change-order-btn btn-size-md">
                              ...
                              <UncontrolledTooltip placement="right" target="toInProgress">
                                Buyurtmani yetkazish holatiga qaytarish
                              </UncontrolledTooltip>
                            </div>
                            <div className="change-order-btn btn-size-md ml-3">
                              <button
                                ...
                                onClick={
                                  () => {
                                    pushNextModal();
                                    setMyState("myFunction",
                                      () => changeOrder(item.userOrderId, 0))
                                  }}>
                                <span className="icon icon-arrow-go-back-line"/>
                              </button>
                          ...
                          {/*        onClick={() => {*/}
                          {/*          pushNextModal();*/}
                          {/*          setMyState("myFunction", () => changeToPayed(item.userOrderId, false, 3))*/}
                          {/*        }}>*/}
                          ...
                          {/*        onClick={() => {*/}
                          {/*          pushNextModal();*/}
                          {/*          setMyState("myFunction", () => changeToPayed(item.userOrderId, true, 3))*/}
                          {/*        }}>*/}
...
export default CurrentOrderLinksThreeComponent;
