...
class DeleteUnversal extends Component {
    ...
    render() {
        ...
        const deleteSale = () => {
            ...
            dispatch({
                type: 'marketing/deleteMarketing',
                payload: {
            ...
            <div className='right-modal'>
                <Modal id="leftsite" size='md' centered={true} isOpen={props.value.isOpen} className={className}
                    ...
                    <ModalHeader className='position-relative'
                                 toggle={this.props.value.toggle}>
                        <p className="mb-0 fs-16 font-family-semi-bold">Reklamani o`chirish</p>
                    </ModalHeader>
                    <ModalBody>
                        <AvForm className="formModall">
                            <div className="d-flex flex-column h-100">
                                <div className="">
                                    <p className="mb-0 fs-16 font-family-medium text-center">Siz chindan ham bu
                                        reklamani o'chirmoqchimisiz
                                        ?</p>
                                    <p className="mb-0 fs-14 font-family-medium text-center"
                                       style={{color: "#61676d"}}>(Ushbu reklama
                                        ni o`chirganingizdan keyin qaytarib bo`lmaydi.)</p>
                                </div>
                                <div className="mt-auto mb-2">
                                    <div className="d-flex justify-content-start">
                                        <div className="">
                                            <Button className="deleteBtnBenefit benefitBtn mr-3"
                                                    onClick={deleteSale}>O`chirish</Button>
                                            <Button className="benefitBtn cancelBtnBenefit"
                                                    onClick={this.props.value.toggle}>Bekor
                                                qilish</Button>
                                        </div>
                                    </div>
                                </div>
